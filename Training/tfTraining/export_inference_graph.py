...
python export_inference_graph.py --input_type image_tensor --pipeline_config_path training_ssd/ssd_inception_v2_coco.config --trained_checkpoint_prefix training_ssd/model.ckpt-13302 --output_directory OCR
